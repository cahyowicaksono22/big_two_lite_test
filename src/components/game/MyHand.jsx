        ...
        <div className="flex flex-col items-center gap-3">
            ...
            <AnimatePresence>
                {groupedCards.length > 0 && (
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            {groupedCards.map((group, groupIdx) => (
                                <motion.div
                                    ...
                                    className="relative flex items-end gap-0.5 px-2.5 py-2 rounded-xl
                        ...
                        {/* Divider */}
                        <div className="w-48 h-px bg-gradient-to-r from-transparent via-glass-border to-transparent" />
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <div className="flex gap-2">
                <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-white/5 border border-glass-border
                        text-text-secondary text-[11px] hover:bg-white/10 hover:text-text-primary
            ...
            {/* Main Hand Cards */}
            <div className="flex flex-wrap justify-center gap-1.5 px-2 max-w-[640px]">
            ...
            {hasSelection && (
                <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className={`text-[11px] ${selectedCards.length >= 5 ? 'text-amber-400' : 'text-gold-400'}`}
                >
